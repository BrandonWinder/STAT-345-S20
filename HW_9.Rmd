...
list.extractor(cool.list, i.to.keep=2:4, i.to.remove=4) # Should get list with lets, fracs, and bools (the i.to.remove argument should be ignored)
```